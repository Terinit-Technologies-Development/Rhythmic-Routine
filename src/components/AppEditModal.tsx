...
export const AppEditModal: React.FC = () => {
  ...
  const [classification, setClassification] = useState<AppClassification>('normal');
  const [selectedGroupId, setSelectedGroupId] = useState<string>('social');

  useEffect(() => {
    if (selectedApp) {
      setClassification(selectedApp.classification);
      setSelectedGroupId(selectedApp.riskGroupId || 'social');
    }
  }, [selectedApp]);
    ...
    <View style={styles.overlay}>
      ...
      <View style={styles.modalCard}>
        ...
        <View style={styles.header}>
          ...
          <TouchableOpacity style={styles.closeBtn} onPress={closeAppEdit}>
        ...
        <View style={styles.footer}>
          <TouchableOpacity style={styles.cancelBtn} onPress={closeAppEdit}>
